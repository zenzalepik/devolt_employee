...
class ReimbursDetailContent extends StatelessWidget {
  ...
  ReimbursDetailContent({required this.reimbursementData});
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('#${reimbursementData['id']}',
                        style: TextStyles.text16px700(
                            color: AppColors.grey63Color)),
                    Row(
                      children: [
                        Expanded(
                            child: Text('${reimbursementData['allocations']}'.toUpperCase(),
...
class ReimbursDetail extends StatefulWidget {
  ...
  ReimbursDetail({required this.reimbursementData});
...
class _ReimbursDetailState extends State<ReimbursDetail> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> _widgetOptions = [
      ReimbursDetailContent(reimbursementData: widget.reimbursementData),
    ];
    return Scaffold(
