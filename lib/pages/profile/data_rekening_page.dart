...
class DataRekeningPage extends StatefulWidget {
  const DataRekeningPage({super.key});

  @override
  State<DataRekeningPage> createState() => _DataRekeningPageState();
}

class _DataRekeningPageState extends State<DataRekeningPage> {
                              ...
                              Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    DropdownOutlineW(
                                      labelText:
                                          'BNI/BCA/BRI', // Label untuk dropdown
                                      items: [
                                        'Item 1',
                                        'Item 2',
                                        'Item 3'
                                    ...
                                    DropdownOutlineW(
                                      labelText:
                                          '210442343243242', // Label untuk dropdown
                                      items: [
                                        'Item 1',
                                        'Item 2',
                                        'Item 3'
