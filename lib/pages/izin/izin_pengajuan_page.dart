...
class IzinPengajuanContent extends StatefulWidget {
  // const IzinPengajuanContent({super.key});

  @override
  State<IzinPengajuanContent> createState() => _IzinPengajuanContentState();
}

class _IzinPengajuanContentState extends State<IzinPengajuanContent> {
